...
class AsakusaUpgradeTest {
    ...
    /**
     * Test for {@code 4.7} (Asakusa Distribution {@code 0.10.1}).
     */
    @Test
    void 'v4.7'() {
    ...
    /**
     * Test for {@code 4.3.1} (Asakusa Distribution {@code 0.10.0}).
     */
    @Test
    void 'v4.3.1'() {
        doUpgradeFromTestName()
    ...
    /**
     * Test for {@code 3.4.1} (Asakusa Distribution {@code 0.9.1}).
     */
    @Test
    void 'v3.4.1'() {
        doUpgradeFromTestName()
